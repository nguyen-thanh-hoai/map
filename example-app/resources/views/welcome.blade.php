        ...
        <div class="page-wrapper mt-10">
            <div class="wrapper wrapper--w900 bg-white p-6">
                ...
                <div class="container">
                        ...
                        <div class="grid grid-cols-1">
                            <div class="font-medium mb-5">
                                ...
                                <div class="rounded-2xl border p-3">
                                    <input class="" type="text" placeholder="Le Thi My Na">
                                </div>
                            </div>
                            <div class="font-medium mb-5">
                                <label for="">Email</label>
                                <div class="rounded-2xl border p-3">
                                    <input class="" type="text" placeholder="johndoe@mail.com">
                                </div>
                            </div>
                    ...
                    <div class="text-center flex mt-3 justify-center"><p>Bạn chưa có tài khoản?</p> <a href="" class="font-bold mx-2" style="color: #90075D;">Đăng nhập</a></div>
                    <div class="justify-center flex mt-5">
                        <div class="grid grid-cols-3 lg:grid-cols-3 md:grid-cols-3 lg:gap-6 ">
                            <div style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);"><a href=""><img src="google.png" class="w-12" alt=""></a></div>
                            <div style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);"><a href=""><img src="facebook.png" class="w-12" alt=""></a></div>
                            <div style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);"><a href=""><img src="twitter.png" class="w-12" alt=""></a></div>
                        </div>
                    </div>
                </div>
            </div>

    ...
    <div class="container mt-5">
        <div class="page-wrapper mt-10">
            <div class="wrapper wrapper--w900 bg-white p-6">
                ...
                <div class="container">
                    <form action="{{route('loginstoreprocess')}}" method="post">
                        @csrf
                        <div class="grid grid-cols-1">
                            ...
                            <button type="submit" class="text-center mt-10 p-3 text-white font-semibold rounded" style="background-color: #90075D;">Đăng Nhập</button>
                        </div>
                    </form>
                    <div class="text-center flex mt-3 justify-center">
                        <p>Bạn chưa có tài khoản?</p> <a href="{{route('registerstore')}}" class="font-bold mx-2" style="color: #90075D;">Đăng ký</a>
                    </div>

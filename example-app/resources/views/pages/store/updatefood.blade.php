      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="{{route('updatefoodprocess')}}" method="post" enctype="multipart/form-data">
            @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="">Name</label>
                  <input type="text" name="name" value="{{$getDataProductById[0]->name}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                  <input type="hidden" name="id" value="{{$getDataProductById[0]->id}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                </div>
                <div class="form-group">
                  <label for="">Description</label>
                  <textarea class="textarea" name="description" id="noidung" maxlength="500" cols="30" rows="10">{{$getDataProductById[0]->description}}</textarea>
                </div>
                <div class="form-group">
                  <label for="">Category</label>
                  <input type="text" name="category"  value="{{$getDataProductById[0]->category}}"class="form-control" id="danhmuc" maxlength="100" required placeholder="Enter danh mục"> 
                </div>
                <div class="form-group">
                  <label for="">Price</label>
                  <input type="number" name="price" value="{{$getDataProductById[0]->price}}" class="form-control" id="the" maxlength="100" required placeholder="Enter thẻ">
                </div>
                <div class="form-group">
                  <label for="">Hình</label>
                  <input type="file" name="img_food" class="form-control" maxlength="100" id="hinh">
                  <img style="width:300px" src="../uploads/{{$getDataProductById[0]->img_food}}" alt="hinh">
                </div>
              </div>

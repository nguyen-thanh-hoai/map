...
<div class="row">
    ...
    <div class="col-md-10 col-10">
        ...
        <body style="font-family: Arial, sans-serif;">
            ...
            <div class="container">
                <form action="{{route('searchFoodByName')}}" method="get">
            ...
            <div class=" offset-md-9 btn btn-primary">
                ...
                <a href="{{route('createfood')}}" class="nav-link" style="color: #fff">
                    CREATE
                </a>
            </div>
            <div class="container">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex;">
                                    <form action="{{route('getdatafoodbyid')}}" method="post">
                                    @csrf
                                    ...
                                    <form action="{{route('deletefoodprocess')}}" method="post">
                                    @csrf
                                        <input type="hidden" name="id" value="{{$value->id}}">
                                        <button type="submit" class="btn btn-dark animate-up-2">
                                        Delete

    ...
    <div class="container mt-5">
        <div class="page-wrapper mt-10">
            <div class="wrapper wrapper--w900 bg-white p-6">
                ...
                <div class="container">
                    <form action="{{route('registerstoreprocess')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1">
                            <div class="font-medium mb-5">
                                <label for="">Tên Cửa Hàng</label>
                                <div class="rounded-2xl border p-3">
                                    <input class="" name="namestore" type="text" placeholder="Le Thi My Na">
                                    <input class="" name="id" value="{{$getDataById[0]->id}}" type="hidden" placeholder="Le Thi My Na">
                            ...
                            <div class="font-medium mb-5">
                                ...
                                <div class="rounded-2xl border p-3">
                                    <div>{{$getDataById[0]->email}}</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Hình</label>
                                <input type="file" name="img_store" class="form-control" maxlength="100" required id="hinh">
                            </div>
                            <button type="submit" class="text-center mt-10 p-3 text-white font-semibold" style="background-color: #90075D;">Đăng Ký</button>
                        </div>
                    </form>
                    <div class="text-center flex mt-3 justify-center">
                        <p>Bạn chưa có tài khoản?</p> <a href="{{route('loginstore')}}" class="font-bold mx-2" style="color: #90075D;">Đăng nhập</a>
                    </div>
                </div>
            </div>
        </div>

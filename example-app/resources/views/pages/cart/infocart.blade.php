        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="{{route('registerInfoCart')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" maxlength="255" required placeholder="Enter Email">
                  </div>
                  <div class="form-group">
                    <label for="">Number Phone</label>
                    <input type="number" name="number_phone" class="form-control" id="tieude" maxlength="10" required placeholder="Enter Number phone">
                  </div>
                  <div class="form-group">

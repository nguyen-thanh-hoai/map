                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="updatestoreprocess" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="">Email</label>
                                        <input type="text" name="email" value="{{$getDataStore[0]->email}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                                        <input type="hidden" name="id" value="{{$getDataStore[0]->id}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Password</label>
                                        <input type="text" name="password" value="" class="form-control" id="tieude" maxlength="255"  placeholder="Enter tiêu đề">
                                    </div>
                                    <div class="form-group">
                                        <label for="">User Name</label>
                                        <input type="text" name="username" value="{{$getDataStore[0]->username}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Name Store</label>
                                        <input type="text" name="namestore" value="{{$getDataStore[0]->namestore}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Role</label>
                                        <input type="text" name="role" value="{{$getDataStore[0]->role}}" class="form-control" id="tieude" maxlength="255" required placeholder="Enter tiêu đề">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="">Hình</label>
                                        <input type="file" name="img_store" class="form-control" maxlength="100" id="hinh">
                                        <img style="width:300px" src="../uploads/{{$getDataStore[0]->img_store}}" alt="hinh">
                                    </div>
                                </div>
